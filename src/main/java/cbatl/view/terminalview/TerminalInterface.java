...
public class TerminalInterface extends EventTarget{
 ...
 */
  ...
  public String waitingForAnswer(HashMap<String, String> hm)
  {
    ...
    while(true)
    {
        ...
        if(ls.contains(input)) 
            ...
            this.println("Entree non conforme. Reessayez");
  ...
  public void createPlayer()
  {
    ...
    if(newPLayerName == "quitter" || newPLayerName == "quit")
      this.dispatchEvent(new MainMenuEvent());
    else{
      //this.dispatchEvent();
      this.println("Joueur cree");
      this.println("Creer autre joueur? y/n");
